...
// APMC Mandis Directory across states with benchmark modal price feeds from AGMARKNET
export const APMC_MANDI_RECORDS: MandiPriceRecord[] = [
  // Madhya Pradesh Mandis
  {
    mandiId: "mp_indore_01",
    mandiName: "Indore (Choithram APMC)",
    district: "Indore",
    state: "Madhya Pradesh",
    cropId: "soybean",
    cropName: "Soybean (Yellow)",
    distanceKm: null,
    minPricePerQuintal: 4420,
    maxPricePerQuintal: 4780,
    modalPricePerQuintal: 4650,
    dailyArrivalsTonnes: 1850,
    ...
    retrievedAt: "2024-10-16 09:30 IST",
  ...
  },
  {
    ...
    cropName: "Soybean (Yellow)",
    distanceKm: null,
    minPricePerQuintal: 4350,
    maxPricePerQuintal: 4690,
    modalPricePerQuintal: 4580,
    dailyArrivalsTonnes: 950,
    arrivalTrend: "Stable",
    freightCostPerKmPerQuintal: null,
    hamaliChargesPerQuintal: null,
    mandiCessPercent: 1.5,
    ...
    source: "AGMARKNET — Directorate of Marketing & Inspection, MoA&FW",
    dataset: "Daily APMC Wholesale Market Rates & Arrivals Bulletin",
    retrievedAt: "2024-10-15 10:15 IST",
    dataStatus: "OFFICIAL DATA",
    metadata: AGMARKNET_METADATA
  },
  {
    ...
    cropName: "Gram / Chana",
    distanceKm: null,
    minPricePerQuintal: 5620,
    maxPricePerQuintal: 6180,
    modalPricePerQuintal: 5920,
  ...
  // Maharashtra Mandis
  {
    ...
    maxPricePerQuintal: 2850,
    modalPricePerQuintal: 2400,
    dailyArrivalsTonnes: 3600,
    arrivalTrend: "Increasing",
    freightCostPerKmPerQuintal: null,
    hamaliChargesPerQuintal: null,
  ...
  },
  {
    ...
    distanceKm: null,
    minPricePerQuintal: 7050,
    maxPricePerQuintal: 7700,
    modalPricePerQuintal: 7420,
  ...
  },
  {
    ...
    cropName: "Tur / Arhar",
    distanceKm: null,
    minPricePerQuintal: 9750,
    maxPricePerQuintal: 11200,
    modalPricePerQuintal: 10500,
  ...
  // Gujarat Mandis
  {
    ...
    distanceKm: null,
    minPricePerQuintal: 6150,
    maxPricePerQuintal: 7100,
  ...
  },
  {
    ...
    distanceKm: null,
    minPricePerQuintal: 7150,
    maxPricePerQuintal: 7700,
    modalPricePerQuintal: 7500,
